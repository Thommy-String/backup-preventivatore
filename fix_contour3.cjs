                ...
                {drawing.leafRects.map((r, i) => {
                    ...
                    return (
                        <g key={\`outer-outline-\${i}\`}>
                            ...
                            {/* internal mullion vertical lines omitted to prevent doubling */}
                            {!isLastRow && !isShorter && <line x1={rx} y1={ry + rh} x2={rx + rw} y2={ry + rh} strokeLinecap="square" />}
                            ...
                            {isShorter && <line x1={rx} y1={totalWinH + frame_mm} x2={rx + rw} y2={totalWinH + frame_mm} strokeLinecap="square" strokeDasharray="4,4" stroke={"#ddd"} />}
                        </g>
                    );
                })}
            </g>
